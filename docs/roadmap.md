...
4. **Phase 1 embedding:** [組み込みAPI仕様](embedding-api.md) ~~E1〜E6~~（✅ 完了）→ **E8a**（CLI を Engine API だけへ統合、基本引数転送、AUD-018）。REV-007/008/011/013/014/020 はこの Phase 1〜2 で解消する。
