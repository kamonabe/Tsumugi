...
2. **意味論基盤:** 内部refactor → ~~AUD-050/017深度統合~~（✅ 完了） → ~~AUD-049単一BuiltinSpec~~（✅ 完了） → ~~AUD-019 canonical error~~（✅ 完了） → ~~AUD-047 COW~~（✅ 完了）/~~AUD-048 FunctionId~~（✅ 完了） → AUD-016 binding/AUD-024 transaction → AUD-034/036/018/033境界挙動の順で進める。
